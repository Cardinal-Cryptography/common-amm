...
pub async fn upload<TxInfo, E, C: ink_wrapper_types::SignedConnection<TxInfo, E>>(
    ...
    let wasm = include_bytes!("../../target/ink/psp22_token/psp22_token.wasm");
    let tx_info = conn
        .upload(
            (*wasm).into(),
            vec![
                88, 35, 214, 153, 129, 33, 99, 28, 180, 252, 43, 221, 82, 85, 168, 170, 254, 95,
                78, 183, 3, 39, 221, 54, 254, 188, 129, 42, 249, 84, 6, 212,
            ],
        )
        .await?;
...
impl Instance {
    ...
    pub async fn new<TxInfo, E, C: ink_wrapper_types::SignedConnection<TxInfo, E>>(
        ...
        let data = {
            ...
            total_supply.encode_to(&mut data);
        ...
        let code_hash = [
            88, 35, 214, 153, 129, 33, 99, 28, 180, 252, 43, 221, 82, 85, 168, 170, 254, 95, 78,
            183, 3, 39, 221, 54, 254, 188, 129, 42, 249, 84, 6, 212,
        ];
    ...
    #[allow(dead_code, clippy::too_many_arguments)]
    pub async fn mint<TxInfo, E, C: ink_wrapper_types::SignedConnection<TxInfo, E>>(
        &self,
        conn: &C,
        account: ink_primitives::AccountId,
        amount: u128,
    ) -> Result<TxInfo, E> {
        let data = {
            let mut data = vec![207, 221, 154, 162];
